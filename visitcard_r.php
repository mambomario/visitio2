...
<nav></nav>
			    ...
			    <div class="visitio">
			        ...
			        <div class="contact_group">
			            ...
			            <div class="contacts">                
			                ...
			                <button class="social_button email"> <i class="fas fa-envelope"></i> <a href="mailto:<?php echo $visitcard_item['email']; ?>" target="_blank">esai@company.com</a> </button>
        ...
        <div class="save row">
            ...
            <!-- NEW CODE  -->
            <div class="col-xs-6 col-sm-6"> <button class="save_to_contacts"> Save to Contacts <i class="fas fa-user-alt"></i> <i class="fas fa-bars"></i> </button> 
                <img class="vcficon" src="./assets/images/icons/vcf.png" alt="">
            </div>
            <div class="col-xs-6 col-sm-6"> <button class="save_to_app"> Save to App <span class="blackfont">Visit.io</span> </button> </div>
